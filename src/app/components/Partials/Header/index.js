    ...
    <header className={`z-20 px-4 lg:px-6 py-2.5 w-full transition-all duration-300 ${
      ...
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div className="flex items-center lg:order-2">
          ...
          <button onClick={toggleMenu} type="button" className="inline-flex items-center p-2 ml-1 text-xl text-white border border-white rounded-lg lg:hidden hover:bg-white hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-white dark:text-white dark:hover:bg-white dark:hover:text-gray-900 dark:focus:ring-white" aria-controls="mobile-menu-2" aria-expanded={isMenuOpen}>
