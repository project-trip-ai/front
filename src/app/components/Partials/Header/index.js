    ...
    <header className={`z-10 px-4 lg:px-6 py-2.5 w-full transition-all duration-300 ${
      ...
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
         <Link href="/" className="flex items-center">
            ...
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Wizard Planner</span>
          </Link>
          ...
          {isLoggedIn !== false ? (
              <>
                <Link
                  ...
                  className="text-white border border-white hover:bg-white hover:text-black focus:ring-4 focus:ring-white font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:text-white dark:hover:bg-white dark:hover:text-black dark:focus:ring-white focus:outline-none"
                >
                  Profile
                </Link>
                <button
        ...
        <div className={`justify-between items-center w-full lg:flex lg:w-auto lg:order-1 ${isMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu-2">
          <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            <Link
              ...
              className={`block py-2 pr-4 pl-3 border-b border-white hover:bg-white hover:text-black lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-white dark:hover:bg-white dark:hover:text-black lg:dark:hover:bg-transparent ${activeLink === '/plan-trip' ? 'font-bold' : 'text-white'}`}
            >
              Plan Your Trip
            </Link>
            <Link
              ...
              className={`block py-2 pr-4 pl-3 border-b border-white hover:bg-white hover:text-black lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-white dark:hover:bg-white dark:hover:text-black lg:dark:hover:bg-transparent ${activeLink === '/subscription' ? 'font-bold' : 'text-white'}`}
            >
              Price
            </Link>
          </ul>
