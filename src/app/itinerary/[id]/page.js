      ...
      <div className="min-h-screen flex">
        ...
        <div className="grid w-full h-80 content-between bg-gradient-to-b from-gray-700 via-gray-300 to-gray-700 px-10 py-5">
          ...
          <div className="w-full flex justify-between">
            <Button rounded="rounded-md" opacity="bg-opacity-20">Back</Button>
            <Button opacity="bg-opacity-20">Share</Button>
          </div>
          <div className="w-full">
            <h1 className="text-5xl font-extrabold text-white">Country</h1>
            <div className="flex space-x-2 mt-4">
            <Button border="border" borderColor="border-gray-400" opacity="bg-opacity-10">09 Dec 24</Button>
            <Button border="border" borderColor="border-gray-400" opacity="bg-opacity-10">2 People</Button>
            </div>
          </div>
